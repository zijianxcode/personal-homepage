(function () {
    ...
    const exact = {
        ...
        '未评分': 'Unrated',
        '已进入近 3 天资讯池，可先按 AI / NLP 方向暂存观察。': 'Added to the 3-day intake pool; temporarily track it under AI / NLP.',
        '已进入近 3 天资讯池，可先按 AI / HCI 方向暂存观察。': 'Added to the 3-day intake pool; temporarily track it under AI / HCI.',
        '已进入近 3 天资讯池，可先按 AI / ML 方向暂存观察。': 'Added to the 3-day intake pool; temporarily track it under AI / ML.',
        '已进入近 3 天资讯池，可先按 AI / CV 方向暂存观察。': 'Added to the 3-day intake pool; temporarily track it under AI / CV.',
        '研究主题分布': 'Research Topic Distribution',
        '基准、指标、可复现性和评测方法。': 'Benchmarks, metrics, reproducibility, and evaluation methods.',
        '用户体验、人机协作、界面理解与设计方法。': 'User experience, human-AI collaboration, interface understanding, and design methods.',
        '多模态理解、视觉语言模型与跨模态推理。': 'Multimodal understanding, vision-language models, and cross-modal reasoning.',
        '公平性、信任、问责与敏感场景边界。': 'Fairness, trust, accountability, and sensitive-context boundaries.',
        '自主规划、工具调用、多 Agent 协作与执行链路。': 'Autonomous planning, tool use, multi-agent collaboration, and execution chains.',
        '基于源目录中论文总结自动汇总的 AI 相关记录。': 'AI records automatically summarized from source paper notes.',
        '合并人机交互、用户体验、界面理解和设计方法相关材料。': 'Merged HCI, UX, interface understanding, and design-method materials.',
        '基于关键词自动归类的训练、优化与模型方法研究。': 'Keyword-classified training, optimization, and model-method research.',
        '基于关键词自动归类的语言与文本研究。': 'Keyword-classified language and text research.',
        '基于关键词自动归类的视觉、图像、视频与 3D 研究。': 'Keyword-classified vision, image, video, and 3D research.',
        '悠仁': 'Yuji',
        '野蔷薇': 'Nobara',
        '惠': 'Megumi',
        '五条悟': 'Gojo',
        ...
        '中。': '.',
        '元数据': 'Metadata',
        '研究背景与问题': 'Research Background and Questions',
        '背景': 'Background',
        '1 背景': '1 Background',
        '核心问题': 'Core Question',
        '2 核心问题': '2 Core Question',
        '现有局限': 'Current Limits',
        '3 现有局限': '3 Current Limits',
        '核心方法/系统架构': 'Core Method / System Architecture',
        '系统概述': 'System Overview',
        '1 系统概述': '1 System Overview',
        '四大组件架构': 'Four-Component Architecture',
        '2 四大组件架构': '2 Four-Component Architecture',
        '关键设计决策': 'Key Design Decisions',
        '3 关键设计决策': '3 Key Design Decisions',
        '原型实现': 'Prototype Implementation',
        '4 原型实现': '4 Prototype Implementation',
        '实验与评估': 'Experiments and Evaluation',
        '形成性研究（Formative Studies）': 'Formative Studies',
        '1 形成性研究（Formative Studies）': '1 Formative Studies',
        '星级概览': 'Rating Overview',
        '角色打星': 'Role Ratings',
        '角色摘录': 'Role Excerpts',
        '野蔷薇 · 5/5': 'Nobara · 5/5'
    };
    ...
    const patterns = [
        ...
        [/^(\d+)\s+条记录$/, '$1 records'],
        [/^共\s+(\d+)\s+条$/, '$1 records'],
        [/^匹配\s+(\d+)\s+条\s+·\s+最新一天$/, 'Matched $1 records · Latest Day'],
        [/^匹配\s+(\d+)\s+条\s+·\s+近\s+3\s+天$/, 'Matched $1 records · Last 3 Days'],
        [/^匹配\s+(\d+)\s+条\s+·\s+近\s+7\s+天$/, 'Matched $1 records · Last 7 Days'],
        [/^匹配\s+(\d+)\s+条\s+·\s+本月$/, 'Matched $1 records · This Month'],
        [/^匹配\s+(\d+)\s+条\s+·\s+最新一天\s+·\s+周会讨论$/, 'Matched $1 records · Latest Day · Meeting Notes'],
        [/^匹配\s+(\d+)\s+条\s+·\s+近\s+3\s+天\s+·\s+周会讨论$/, 'Matched $1 records · Last 3 Days · Meeting Notes'],
        [/^匹配\s+(\d+)\s+条\s+·\s+近\s+7\s+天\s+·\s+周会讨论$/, 'Matched $1 records · Last 7 Days · Meeting Notes'],
        [/^匹配\s+(\d+)\s+条\s+·\s+本月\s+·\s+周会讨论$/, 'Matched $1 records · This Month · Meeting Notes'],
        [/^匹配\s+(\d+)\s+条\s+·\s+最新一天\s+·\s+评审会$/, 'Matched $1 records · Latest Day · Review'],
        [/^匹配\s+(\d+)\s+条\s+·\s+近\s+3\s+天\s+·\s+评审会$/, 'Matched $1 records · Last 3 Days · Review'],
        [/^匹配\s+(\d+)\s+条\s+·\s+近\s+7\s+天\s+·\s+评审会$/, 'Matched $1 records · Last 7 Days · Review'],
        [/^匹配\s+(\d+)\s+条\s+·\s+本月\s+·\s+评审会$/, 'Matched $1 records · This Month · Review'],
        ...
        [/^已进入近\s+3\s+天资讯池，可先按\s+(.+)\s+方向暂存观察。$/, 'Added to the 3-day intake pool; temporarily track it under $1.'],
